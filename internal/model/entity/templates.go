...
type Templates struct {
	...
	TemplateType string      `json:"templateType" description:"模板类型：basic=基础模板，scaffold=脚手架模板，data_driven=数据驱动模板"`
	TypeConfig   string      `json:"typeConfig"   description:"类型相关配置，JSON格式"`
}
