  ...
  >
    ...
    >
      ...
      <n-form-item label="显示名称" path="display_name">
        <n-input
          v-model:value="localForm.display_name"
          placeholder="请输入显示名称"
          maxlength="50"
          show-count
        />
      ...
      <n-form-item label="热门语言" path="isPopular">
        <n-switch v-model:value="localForm.isPopular" />
      </n-form-item>
    </n-form>
...
import { addLanguage, editLanguage } from '@/api/languages'
...
watch(() => props.form, (newForm) => {
  localForm.value = {
    ...
    color: newForm.color || '#18a058',
    sort: newForm.sort || 0,
    isPopular: newForm.isPopular || 0
  }
...
const rules = {
  name: [
    ...
    { min: 1, max: 50, message: '语言名称长度在 1 到 50 个字符', trigger: 'blur' }
  ],
  code: [
    { required: true, message: '请输入语言代码', trigger: 'blur' },
    { min: 1, max: 20, message: '语言代码长度在 1 到 20 个字符', trigger: 'blur' },
    { pattern: /^[a-zA-Z-]+$/, message: '语言代码只能包含字母和连字符', trigger: 'blur' }
  ],
  display_name: [
